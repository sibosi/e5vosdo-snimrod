...
export default async function Home() {
  ...
  nextFullMinute.setSeconds(0);
  nextFullMinute.setMilliseconds(0);
  nextFullMinute.setMinutes(nextFullMinute.getMinutes() + 1);

  return (
    <div>
      <PageHeadContent selfUser={selfUser} carouselEvents={carouselEvents} />
      <FinalCountdown date={nextFullMinute.toISOString()} />
