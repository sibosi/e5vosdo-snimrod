    ...
    fetch("/api/getAllTags", {
      ...
      .then((data) => {
        if (Array.isArray(data)) {
          // Filter out the main Szalagavató tag since it's always applied
          setAvailableTags(data.filter((t) => t.tag_name !== SZALAGAVATO_TAG));
        }
      })
      .catch((err) => {
...
export default SzalagavatoGallery;
