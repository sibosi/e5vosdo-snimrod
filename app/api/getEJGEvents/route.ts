        ...
        try {
          ...
          if (month !== undefined && !isNaN(day)) {
            ...
            const event: EventType = {
              ...
              description: null,
              hide_time: new Date(eventDate.getTime() + 7 * 24 * 60 * 60 * 1000).toISOString(), // Hide after 7 days
              show_time: new Date(eventDate.getTime() - 28 * 24 * 60 * 60 * 1000).toISOString(), // Show 28 days before
              tags: ["EJG"],
              image: null
            };
