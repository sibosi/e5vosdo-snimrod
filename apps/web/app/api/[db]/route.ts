...
const modules = {
  parlament: import("@/apps/web/db/parlament"),
  autobackup: import("@/apps/web/db/autobackup"),
  event: import("@/apps/web/db/event"),
  supabaseStorage: import("@/apps/web/db/supabaseStorage"),
  images: import("@/apps/web/db/images"),
  matches: import("@/apps/web/db/matches"),
  pageSettings: import("@/apps/web/db/pageSettings"),
  mediaPhotos: import("@/apps/web/db/mediaPhotos"),
};
