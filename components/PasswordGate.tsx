        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              placeholder="Jelszó"
              className={`focus:outline-hidden w-full rounded-lg border-2 bg-foreground-50 px-4 py-3 text-center text-lg transition focus:ring-2 ${
                error
          ...
          <button
            type="submit"
            className="focus:outline-hidden w-full rounded-lg bg-selfprimary-600 py-3 font-semibold text-white transition hover:bg-selfprimary-700 focus:ring-2 focus:ring-selfprimary-500 focus:ring-offset-2"
          >
            Belépés
          </button>
        </form>
