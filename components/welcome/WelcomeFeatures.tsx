      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        >
          <div className="grid md:grid-cols-2">
            ...
            <div className="backdrop-blur-xs p-6 md:p-8">
        ...
        >
          <div className="grid md:grid-cols-2">
            <div className="p-6 md:p-8">
              <div className="mb-4 flex items-center gap-3">
                <div className="bg-linear-to-br rounded-full from-green-500 to-teal-600 p-3 text-foreground">
            ...
            <div className="backdrop-blur-xs p-6 md:p-8">
              ...
              <Link href="/est">
                <Chip
                  color="primary"
                  variant="flat"
                  className="backdrop-blur-xs cursor-pointer bg-foreground/10 text-foreground"
                >
                  Összes epizód →
                </Chip>
              </Link>
