...
("Kedves Diákok!\nAz előadásjelentkezés elkezdődött itt <a href='https://info.e5vosdo.hu/e5n' className='text-selfsecondary-700'>info.e5vosdo.hu/e5n</a> oldalon.", "bg-selfprimary-300 border-selfprimary-400 mx-auto text-xl", 1, 0);